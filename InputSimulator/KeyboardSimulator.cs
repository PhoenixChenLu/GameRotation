...
namespace InputSimulator
{
	...
	public class KeyboardSimulator : IKeyboardSimulator
	{
		...
		public IKeyboardSimulator KeyDown(VKeys key)
		{
			return KeyDown((VirtualKeyCode)key);
		}
		...
		public IKeyboardSimulator KeyUp(VKeys key)
		{
			return KeyUp((VirtualKeyCode)key);
		}
		...
		public IKeyboardSimulator KeyPress(VKeys key)
		{
			return KeyPress((VirtualKeyCode)key);
		}
		...
		public IKeyboardSimulator ModifiedKeyStroke(VKeys modifierKey, VKeys key)
		{
			return ModifiedKeyStroke((VirtualKeyCode)modifierKey, (VirtualKeyCode)key);
		}
		...
		public IKeyboardSimulator ModifiedKeyStroke(IEnumerable<VKeys> modifierKeys, VKeys key)
		{
			return ModifiedKeyStroke(modifierKeys.Select(key => (VirtualKeyCode)key), (VirtualKeyCode)key);
		}

		public IKeyboardSimulator ModifiedKeyStroke(KeyBinding binding)
		{
			List<VirtualKeyCode>? modifiers = binding.ToModifiers();
			if (modifiers == null) return KeyPress(binding.Key);
			return ModifiedKeyStroke(modifiers, binding.ToVirtualKeyCode());
		}
